...
_TRACES: dict[str, str] = {
    ...
    # --- Trend Finder -------------------------------------------------------
    "loupe": ('<circle cx="10.4" cy="10.4" r="7"/><path d="m20.4 20.4-4.8-4.8"/>'),
    "tendance": ('<path d="m2.6 17.4 6.4-6.6 4 4 8.4-9"/>'
                 '<path d="M16.8 5.8h4.6v4.6"/>'),
    "oeil": ('<path d="M2.4 12S6 5.6 12 5.6 21.6 12 21.6 12 18 18.4 12 18.4 2.4 12 2.4 12Z"/>'
             '<circle cx="12" cy="12" r="3"/>'),
    "coeur": ('<path d="M12 20.4S3.6 15.2 3.6 9.2a4.8 4.8 0 0 1 8.4-3.2 4.8 4.8 0 0 1 '
              '8.4 3.2c0 6-8.4 11.2-8.4 11.2Z"/>'),
    "bulle": ('<path d="M3.4 12A8.6 8.6 0 1 1 7 18.8L3 20.4l1.6-4A8.5 8.5 0 0 1 3.4 12Z"/>'),
    "partage": ('<circle cx="18.4" cy="5.6" r="2.6"/><circle cx="5.6" cy="12" r="2.6"/>'
                '<circle cx="18.4" cy="18.4" r="2.6"/>'
                '<path d="m8 10.5 8-4.2M8 13.5l8 4.2"/>'),
    "cloche": ('<path d="M6 17.4V10a6 6 0 0 1 12 0v7.4l1.6 2H4.4l1.6-2Z"/>'
               '<path d="M9.8 21.6a2.4 2.4 0 0 0 4.4 0"/>'),
    "marque_page": ('<path d="M6.4 3.4h11.2v17.2l-5.6-4-5.6 4V3.4Z"/>'),
    "ampoule": ('<path d="M8.6 18.2h6.8M9.6 21.2h4.4"/>'
                '<path d="M12 2.4a6.6 6.6 0 0 0-3.8 12c.7.5 1.2 1.4 1.2 2.4h5.2c0-1 '
                '.5-1.9 1.2-2.4a6.6 6.6 0 0 0-3.8-12Z"/>'),
